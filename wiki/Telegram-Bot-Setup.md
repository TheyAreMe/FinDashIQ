...
3. `@BotFather` will provide your **Bot API Token** (e.g. `8848080602:AAGWp_GsbXzS5YaO0FFDWgcih0ifuczuRrY`).
4. Paste the token into your [.env](file:///c:/Users/Handyman%20Jack/Repositories/somedayv3/.env) file:
   ```env
   TELEGRAM_BOT_TOKEN=8848080602:AAGWp_GsbXzS5YaO0FFDWgcih0ifuczuRrY
   ```
